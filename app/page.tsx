...
type View = "projects" | "interventions" | "surveys" | "map" | "infrastructure-map" | "intervention-workspace" | "intervention-execution" | "intervention-documentation" | "survey-workspace" | "team" | "cpe" | "drive" | "documents" | "client" | "route" | "splices" | "site";
...
export default function Home() {
  ...
  function goTo(next: View) {
    ...
    if (next === "infrastructure-map" && !canManageDocuments) {
      showToast("Harta de infrastructură nu este disponibilă conturilor de tehnician.");
      return;
    }
    ...
    <main className="app-shell">
      <aside className="sidebar" aria-label="Navigare principală">
        ...
        <nav className="side-nav">
          ...
          {canManageDocuments && <button className={view === "infrastructure-map" ? "active" : ""} onClick={() => goTo("infrastructure-map")}>
            <span className="nav-symbol">GIS</span> Hartă infrastructură
          </button>}
      ...
      <section className="content">
        ...
        {!isProjectView && (
          <nav className={`mobile-section-tabs${canManageDocuments ? " manager-tabs" : ""}`} aria-label="Secțiunile aplicației">
            ...
            {canManageDocuments && <button className={view === "infrastructure-map" ? "active" : ""} onClick={() => goTo("infrastructure-map")}>Infrastructură</button>}
        ...
        {view === "infrastructure-map" && canManageDocuments && <InfrastructureMap role={currentAccount.role} onNotify={showToast} />}
